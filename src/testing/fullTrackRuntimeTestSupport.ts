...
import type { ContentPackageRuntimePort } from "../application/trainingLifecycle";
...
import type { AlgorithmRuntimeCatalog } from "../tracks/coding-interview";
import { ALGORITHM_MODE_IDS } from "../tracks/coding-interview";
