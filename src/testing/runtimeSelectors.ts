...
export const runtimeSelectors = Object.freeze({
  content: Object.freeze({
    ...
    unavailableActive: () => selector("content", "unavailable-active"),
    unavailableActiveAbandon: () => selector("content", "unavailable-active", "abandon"),
    unavailableActiveConfirm: () => selector("content", "unavailable-active", "confirm"),
    unavailableActiveCancel: () => selector("content", "unavailable-active", "cancel"),
    unavailableActiveRetry: () => selector("content", "unavailable-active", "retry"),
    encryptedStorageRetry: () => selector("content", "encrypted-storage", "retry"),
    encryptedStorageRemoval: (status: "base" | "removing" | "error") => selector("content", "encrypted-storage", "removal", status),
    encryptedStorageHold: () => selector("content", "encrypted-storage", "hold"),
    encryptedStorageReturn: () => selector("content", "encrypted-storage", "return"),
    encryptedStorageSuccess: () => selector("content", "encrypted-storage", "success"),
  ...
  practice: Object.freeze({
    ...
    premiumOfferStart: () => selector("practice", "premium-offer", "start"),
    premiumOfferError: () => selector("practice", "premium-offer", "error"),
  ...
  activity: Object.freeze({
    ...
    unavailableDetails: (sessionId: string) => selector("activity", "unavailable-details", sessionId),
    unavailableRow: (sessionId: string) => selector("activity", "unavailable-row", sessionId),
  }),
  review: Object.freeze({
    root: () => selector("review", "root"),
    unavailableSection: () => selector("review", "unavailable-section"),
    unavailableRow: (reviewId: string) => selector("review", "unavailable-row", reviewId),
    unavailableDetails: (reviewId: string) => selector("review", "unavailable-details", reviewId),
    removeUnavailable: (reviewId: string) => selector("review", "remove-unavailable", reviewId),
    removeUnavailableConfirm: (reviewId: string) => selector("review", "remove-unavailable", reviewId, "confirm"),
    removeUnavailableCancel: (reviewId: string) => selector("review", "remove-unavailable", reviewId, "cancel"),
  }),
