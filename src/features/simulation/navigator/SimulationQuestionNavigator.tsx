...
const createStyles = (palette: AppColors) => StyleSheet.create({
  ...
  frozenCell: { borderColor: palette.border, opacity: 0.72 },
  frozenCellText: { color: palette.textMuted },
  operationNotice: { alignItems: "center", backgroundColor: palette.elevatedSurface, borderColor: palette.warning, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: spacing.md, padding: spacing.lg },
  operationNoticeText: { ...typography.small, color: palette.warning, flex: 1 },
  saveFailureStack: { gap: spacing.lg, paddingHorizontal: spacing.xl },
