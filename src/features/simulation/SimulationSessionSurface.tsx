...
const createStyles = (palette: AppColors) => StyleSheet.create({
  ...
  summaryStat: { alignItems: "center", flexDirection: "row", paddingVertical: spacing.md },
  summaryStatLabel: { ...typography.body, color: palette.textSecondary, flex: 1, minWidth: 0 },
  summaryValue: { ...typography.bodyStrong, color: palette.textPrimary, flexShrink: 1, marginLeft: spacing.sm, minWidth: 0, textAlign: "right" },
