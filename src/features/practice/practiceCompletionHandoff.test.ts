...
import type { PracticeCompletionCommandResult, PracticeFinalization } from "../../application/trainingLifecycle";
...
import { isAlgorithmChoiceQuestion, isAlgorithmComplexityQuestion, isAlgorithmOrderingQuestion } from "../../tracks/coding-interview/algorithmQuestionTypes";
