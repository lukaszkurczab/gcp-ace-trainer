...
export function CertificationPracticeSessionScreen({ navigation, route }: Props) {
  ...
  const mode = route.params.mode === "certification-diagnostic-baseline" ? "certification-diagnostic-baseline" : route.params.mode === "certification-focus-practice" ? "certification-focus-practice" : route.params.mode === "certification-scenario-practice" ? "certification-scenario-practice" : route.params.mode === "certification-weak-area-review" ? "certification-weak-area-review" : route.params.mode === "cloud-review" ? "cloud-review" : "cloud-practice";
