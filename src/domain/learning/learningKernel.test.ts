...
test("attempt, evidence, reasons, and learning evidence stay family neutral", () => {
  ...
  assert.throws(() => createTrainingAttempt({ ...attempt, reviewEvidence: { ...attempt.reviewEvidence, sourceItem: { ...attempt.item, trackId: "other-track" } } }), /same resolved content reference/);
