...
export function installCertificationCatalog(bank: PublishedCertificationBank): CertificationContentCatalog { certification = new CertificationContentCatalog(bank.items, bank.contentVersion, bank.diagnosticBaseline, bank.focusPractice, bank.examExperienceProfile, bank.scenarioPractice); return certification; }
