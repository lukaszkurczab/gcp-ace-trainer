...
function verifiedProfile(value: Record<string, unknown>, modeStructures: unknown, manifest: Record<string, unknown>, sourceModes: readonly string[], familyId: "coding_interview" | "certification") {
  ...
  return Object.freeze({ profileId: value.profileId as string, profileVersion: value.profileVersion as string, primaryEntry: Object.freeze({ modeId: value.primaryEntry.modeId, requestedLength: value.primaryEntry.requestedLength }), modes: Object.freeze(modes) });
}
