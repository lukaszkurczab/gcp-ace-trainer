...
export const PUBLISHED_ALGORITHMS_BANK_REQUIRED_KEYS = Object.freeze(["formatVersion", "trackId", "familyId", "contentVersion", "items", "practiceBlueprints", "recognitionSets", "contrastSets", "interleavedScopes", "compatibilitySets", "simulationPools", "simulationProfiles"]);
