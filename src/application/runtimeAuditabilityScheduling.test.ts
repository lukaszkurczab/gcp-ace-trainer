...
const item = { trackId: "coding-interview-dsa-problem-solving" as const, questionId: "alg-complexity-amortized-001", contentVersion: "algorithms-core-0002", artifactSha256: "a".repeat(64) };
