...
export class MutationCommitFailure extends Error {
  constructor(readonly phase: MutationCommitPhase, readonly durableState: MutationDurableState, readonly cause?: unknown) { super(`Canonical mutation could not ${phase === "materialization" ? "materialize" : phase.replaceAll("_", " ")}.`); this.name = "MutationCommitFailure"; }
}
