...
function simulationSession(duration = 2_700_000) {
  return createTrainingSession({
    ...
    itemOrder: Array.from({ length: 40 }, (_, index) => ({ occurrenceId: `occurrence-${index}`, item: { trackId: "coding-interview-dsa-problem-solving", contentVersion: "algorithms-core-0002", artifactSha256: TEST_ARTIFACT_SHA256, questionId: `item-${index}` } })),
    optionOrderByOccurrence: {}, conditionalReinsertSlots: [], activeForegroundMs: 0,
    contentVersion: "algorithms-core-0002", artifactSha256: TEST_ARTIFACT_SHA256, taxonomyVersion: "algorithms-taxonomy-v2", planFingerprint: "a".repeat(64), status: "active", startedAt,
  });
}
...
function certificationPracticeSession() {
  ...
  return createTrainingSession({
    ...
    itemOrder: [{ occurrenceId: "certification-occurrence-1", item: { trackId: "google-cloud-associate-cloud-engineer", contentVersion, questionId: "certification-item-1", artifactSha256: TEST_ARTIFACT_SHA256 } }],
    optionOrderByOccurrence: {}, conditionalReinsertSlots: [], activeForegroundMs: 0,
    contentVersion, artifactSha256: TEST_ARTIFACT_SHA256, taxonomyVersion: "google-cloud-associate-cloud-engineer-taxonomy-v2", planFingerprint: "b".repeat(64), status: "active", startedAt,
  });
}
...
function certificationExamSession() {
  ...
  return createTrainingSession({
    ...
    optionOrderByOccurrence: {}, conditionalReinsertSlots: [], activeForegroundMs: 0,
    contentVersion, artifactSha256: TEST_ARTIFACT_SHA256, taxonomyVersion: "google-cloud-associate-cloud-engineer-taxonomy-v2", planFingerprint: "c".repeat(64), status: "active", startedAt,
  });
}
