...
export async function startCertificationSession(input: Readonly<{ modeId: "certification-diagnostic-baseline" | "certification-focus-practice" | "certification-scenario-practice" | "certification-weak-area-review" | "certification-mixed-practice" | "cloud-practice" | "cloud-review"; requestedLength?: number; domain?: "setup_environment" | "planning_implementation" | "access_security" | "operations"; competency?: string; source?: string }>): Promise<PreparedSession> {
