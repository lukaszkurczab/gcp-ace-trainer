export const groupingAndCanonicalizationQuestions = [
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-001",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "same_equivalence_same_key",
        "feedback": "Two non-equivalent inputs sharing a serialized key is an encoding error. This differs from an internal hash collision between distinct keys, which a correct hash table still distinguishes.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-002",
    "learningStage": "foundations",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "cooperating_strategies",
        "feedback": "Sorting and hashing solve different subproblems. Sorting removes irrelevant order differences by producing a canonical key; the Map then collects all items with that key into one group.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-003",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "frequency_vector",
        "feedback": "A frequency vector preserves both value identity and multiplicity. Because the domain is fixed, each value has a deterministic count position in the signature.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-004",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "sorting_discards_original_order",
        "feedback": "A sorted representation is useful precisely because it normalizes different input orders. That normalization means the original ordering cannot be recovered unless it is stored separately.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-005",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "canonicalization_step",
        "feedback": "A Map compares the keys it receives; it does not infer the application's equivalence relation. If order is irrelevant, the key must first be normalized through sorting, counting, or another deterministic representation.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-006",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "ambiguous_encoding",
        "feedback": "The string does not preserve where one value ends and another begins. Therefore non-equivalent inputs can be assigned the same application-level key before the hash table even processes it.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-007",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "structured_serialization",
        "feedback": "Structured serialization retains sequence boundaries, signs, and multiplicity. The other choices allow distinct multisets to collapse into the same application-level key.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-008",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "different_counts",
        "feedback": "Multiset equality ignores order but preserves multiplicity. The first pair contains different counts of 2 and 5, so it represents two different equivalence classes.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-009",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "sort_frequency_entries",
        "feedback": "The frequency data is correct, but its serialization remains dependent on first-seen order. Canonicalization requires a deterministic order for the frequency entries themselves.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-010",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "n_m_log_m",
        "feedback": "Sorting one m-element collection costs O(m log m). Repeating that work for n collections costs O(nm log m), before accounting for serialization and hashing of the resulting keys.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-011",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "m_plus_sigma",
        "feedback": "The algorithm must read all m values and then construct or encode a σ-position signature. With a truly fixed alphabet, σ is constant and the bound simplifies to O(m).",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-012",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "behavior_depends_on_representation",
        "feedback": "A sorted key commonly costs O(m log m) time and O(m) key or copy space. A frequency signature may cost O(m + σ) time and O(σ) key space, but those bounds depend on whether the domain is fixed, large, or sparse.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-013",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "array_reference_identity",
        "feedback": "The arrays have canonical contents but remain separate object references. A primitive value-based encoding, such as an unambiguous string, is needed unless the environment provides structural key equality.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-014",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "original_items_bucket",
        "feedback": "The canonical key determines group membership, while the Map value retains the original objects or collections. This preserves information intentionally removed from the key.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-015",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "a_b_together",
        "feedback": "A and B both contain two 1s, one 2, and one 3. C contains one 1 and two 2s, so its multiplicity signature differs.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-grouping-016",
    "learningStage": "independent_attempt",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "evaluate_domain_and_contract",
        "feedback": "Both representations can be correct, but under different assumptions. Frequency signatures are attractive for bounded or efficiently countable domains; sorted keys are more general but usually require comparison sorting, copying, and sequence encoding.",
