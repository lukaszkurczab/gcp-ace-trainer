export const complexitySpaceAndMistakeReviewQuestions = [
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-001",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "expected_n_space_n",
        "feedback": "There are n expected constant-time hash operations, so the total expected time is O(n). The keyed state may contain n distinct entries, giving O(n) auxiliary space.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-002",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "sequential_add",
        "feedback": "Sequential phases are added, not multiplied. A constant number of O(n) passes remains O(n), assuming expected constant-time hash operations and constant-cost keys.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-003",
    "learningStage": "foundations",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "nlogn",
        "feedback": "The total is O(n log n + n), which simplifies to O(n log n). The linear scan does not remove the cost of establishing sorted order.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-004",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "expected_not_unconditional",
        "feedback": "Expected lookup and amortized insertion describe different assumptions. Without stronger guarantees, neither proves a worst-case linear pass.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-005",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "state_is_linear",
        "feedback": "Space complexity counts working data retained while the algorithm runs. A constant-sized result does not cancel an O(n)-sized Set or Map.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-006",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "copy_linear",
        "feedback": "Creating a separate n-element array costs O(n) auxiliary space regardless of how much additional workspace the sorting implementation uses.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-007",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "implementation_assumption_needed",
        "feedback": "An in-place interface does not prove O(1) auxiliary memory. Implementations may use O(log n) stack space, O(n) workspace buffers, or other workspace. The assumption must be stated and supported.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-008",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "nk",
        "feedback": "Expected constant-time table access does not make key creation free. Constructing n keys at O(k) each contributes O(nk) work. Hashing long keys may add similar representation-dependent cost.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-009",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "nlogn_times_k",
        "feedback": "The number of comparisons is O(n log n), and each comparison costs O(k), producing O(k n log n). Precomputing comparison keys may change the tradeoff to O(nk + n log n) time with additional storage.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-010",
    "learningStage": "guided_application",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "sort_once_q_scans",
        "feedback": "The O(n log n) preprocessing cost is paid once. Each target still requires an O(n) two-pointer traversal, giving O(n log n + qn) overall.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-011",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "b_only_currently_valid",
        "feedback": "Complexity comparisons apply only among solutions that meet the contract. A faster algorithm that cannot construct the required result is not a valid implementation.",
  ...
  },
  {
    ...
    "id": "alg-contrast-hash-map-vs-sorting-complexity-012",
    "learningStage": "independent_attempt",
    "primarySkillAtomId": "recognize_sorting_tradeoff",
    ...
    "staticMicroChecks": [
      {
        "correctAnswer": "evaluate_full_contract",
        "feedback": "Expected O(n) hashing can be the best option, but the asymptotic time expression is not the entire decision. Memory limits, guarantees, key behavior, repeated use, data representation, mutation rules, and correctness can justify another strategy.",
