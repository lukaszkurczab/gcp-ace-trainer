export const backtrackingComplexityQuestions = [
  {
    ...
    difficulty: "intro",
    id: "alg-backtracking-complexity-001",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_output_size_reasoning",
    secondarySkillAtomIds: ["subset_generation", "complexity_reasoning"],
    type: "single_choice",
    prompt: "A function returns all subsets of n distinct values. What lower bound does the output size impose?",
    options: [
      { id: "two_power_n", text: "It must be able to output 2^n subsets." },
      { id: "n_only", text: "It only needs to output n subsets." },
      { id: "log_n", text: "It can output all subsets in O(log n)." },
      { id: "one_result", text: "It only needs one subset because all subsets are equivalent." },
    ],
    correctAnswerId: "two_power_n",
    feedbackModel: {
      ...
      mistakeTypes: ["complexity_misread", "output_contract_misread"],
  ...
  },
  {
    contentVersion: "algorithms-core",
    difficulty: "intro",
    id: "alg-backtracking-complexity-002",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_output_size_reasoning",
    secondarySkillAtomIds: ["permutation_generation", "complexity_reasoning"],
    type: "single_choice",
    prompt: "A function returns all permutations of n distinct values. What output-size growth should you expect?",
    options: [
      { id: "factorial", text: "n! permutations." },
      { id: "linear", text: "n permutations." },
      { id: "constant", text: "One permutation." },
      { id: "logarithmic", text: "log n permutations." },
    ],
    correctAnswerId: "factorial",
    feedbackModel: {
  ...
  },
  {
    ...
    id: "alg-backtracking-complexity-003",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_output_size_reasoning",
    secondarySkillAtomIds: ["combination_generation", "exact_length_contract"],
    type: "single_choice",
    ...
    options: [
      { id: "n_choose_k", text: "C(n, k), the number of k-element subsets." },
      { id: "n_factorial", text: "n!, because order always matters." },
      { id: "two_n_only", text: "2n, because each candidate has two states." },
      { id: "one", text: "One output, because k is fixed." },
    ],
    correctAnswerId: "n_choose_k",
    feedbackModel: {
      ...
      mistakeTypes: ["complexity_misread", "permutation_combination_confused"],
  ...
  },
  {
    contentVersion: "algorithms-core",
    difficulty: "foundational",
    id: "alg-backtracking-complexity-004",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_output_size_reasoning",
    secondarySkillAtomIds: ["backtracking_result_collection", "unnecessary_search_space"],
    type: "single_choice",
    ...
    options: [
      { id: "many_outputs", text: "Because the number of valid outputs itself may be exponential." },
      { id: "backtracking_always_bad", text: "Because backtracking is always the wrong strategy." },
      { id: "recursion_slow", text: "Because recursive calls are always slower than loops by definition." },
      { id: "sorting_missing", text: "Because exponential time only happens when input is not sorted." },
    ],
    correctAnswerId: "many_outputs",
    feedbackModel: {
  ...
  },
  {
    contentVersion: "algorithms-core",
    difficulty: "foundational",
    id: "alg-backtracking-complexity-005",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_pruning_complexity",
    secondarySkillAtomIds: ["constraint_pruning", "complexity_reasoning"],
    type: "single_choice",
    ...
    options: [
      { id: "reduces_explored_states", text: "Pruning can reduce explored states, but it does not change the fact that many valid combinations may need to be output." },
      { id: "always_linear", text: "Pruning makes the algorithm always O(n)." },
      { id: "removes_recursion", text: "Pruning removes the need for recursive search." },
      { id: "invalidates_results", text: "Any pruning invalidates the result contract." },
    ],
    correctAnswerId: "reduces_explored_states",
    feedbackModel: {
      ...
      mistakeTypes: ["complexity_misread", "pruning_misread"],
  ...
  },
  {
    contentVersion: "algorithms-core",
    difficulty: "foundational",
    id: "alg-backtracking-complexity-006",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_complexity_branching_depth",
    secondarySkillAtomIds: ["backtracking_enumerate_choices", "complexity_reasoning"],
    type: "single_choice",
    ...
    options: [
      { id: "b_power_d", text: "O(b^d) possible branches." },
      { id: "b_plus_d", text: "O(b + d) possible branches." },
      { id: "log_b_d", text: "O(log d) possible branches." },
      { id: "constant", text: "O(1) possible branches." },
    ],
    correctAnswerId: "b_power_d",
    feedbackModel: {
      ...
      mistakeTypes: ["complexity_misread", "branching_factor_misread"],
  ...
  },
  {
    contentVersion: "algorithms-core",
    difficulty: "foundational",
    id: "alg-backtracking-complexity-007",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_complexity_branching_depth",
    ...
    options: [
      { id: "move_per_character", text: "Each matched character may branch into neighboring cells for the next character." },
      { id: "sort_per_character", text: "Each character requires sorting the whole grid." },
      { id: "binary_discard", text: "Each character discards half of the board by sorted order." },
      { id: "one_global_visit", text: "Each cell is visited once globally and never reconsidered." },
    ],
    correctAnswerId: "move_per_character",
    feedbackModel: {
      ...
      mistakeTypes: ["complexity_misread", "grid_movement_misread"],
  ...
  },
  {
    contentVersion: "algorithms-core",
    difficulty: "foundational",
    id: "alg-backtracking-complexity-008",
    learningStage: "foundations",
    primarySkillAtomId: "backtracking_complexity_vs_direct_check",
    secondarySkillAtomIds: ["strategy_selection", "wrong_pattern_selected"],
    type: "single_choice",
    ...
    options: [
      { id: "direct_scan_enough", text: "A direct scan checks every adjacent pair once, so there is no configuration space to enumerate." },
      { id: "needs_all_subsets", text: "The task requires all subsets of characters." },
      { id: "needs_permutations", text: "The task requires every possible ordering of the string." },
      { id: "needs_grid_moves", text: "The task requires moving through neighboring grid cells." },
    ],
    correctAnswerId: "direct_scan_enough",
    feedbackModel: {
