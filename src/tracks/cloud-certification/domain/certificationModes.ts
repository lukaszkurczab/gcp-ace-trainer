...
export const CERTIFICATION_MODES: readonly CertificationModeDefinition[] = [
  ...
  { id: "cloud-practice", title: "Practice", enabled: true, order: 6, defaultQuestionCount: 10 },
  { id: "cloud-exam-simulation", title: "Exam simulation", enabled: true, order: 7 },
  { id: "cloud-review", title: "Review", enabled: true, order: 8 },
];
