...
export class CertificationContentCatalog {
  ...
  constructor(private readonly questions: readonly CertificationQuestion[], private readonly contentVersion: string, private readonly diagnosticBaseline: PublishedCertificationDiagnosticBaseline | undefined, private readonly examExperienceProfile: PublishedCertificationExamExperienceProfile) {
