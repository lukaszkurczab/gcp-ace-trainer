...
/** Figma Page 1 ambient layer shared by the dark Practice and Track screens. */
  ...
  return (
    <View accessibilityElementsHidden pointerEvents="none" style={[StyleSheet.absoluteFill, styles.canvas]}>
      <Svg height={280} style={styles.tealGlow} width={320}>
        <Defs>
          <RadialGradient cx={0} cy={0} gradientTransform="matrix(16 0 0 14 160 140)" id="ambient-teal" r={10}>
            <Stop offset="0" stopColor="#14B7A6" stopOpacity={0.05098} />
            <Stop offset="1" stopColor="#14B7A6" stopOpacity={0} />
          </RadialGradient>
        </Defs>
        <Rect fill="url(#ambient-teal)" height="280" width="320" />
      </Svg>
