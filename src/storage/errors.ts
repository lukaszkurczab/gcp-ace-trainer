...
export class CanonicalWriteConflictError extends Error { constructor(readonly key: string) { super(`A canonical write for ${key} is already in progress.`); this.name = "CanonicalWriteConflictError"; } }
