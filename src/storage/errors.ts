...
export class JournalWriteError extends Error { constructor(cause?: unknown) { super("Unable to persist the pending mutation."); this.name = "JournalWriteError"; this.cause = cause; } }
