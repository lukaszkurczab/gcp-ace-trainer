...
const source = resolve(root, "../patternly-content/artifacts/releases/patternly-core-0005/generated-bundled-content.mjs");
...
if (!release || release.manifest?.releaseId !== "patternly-core-0005" || !Array.isArray(release.artifacts)) {
