...
const source = resolve(root, "../patternly-content/artifacts/releases/patternly-core-0001/generated-bundled-content.mjs");
...
if (!release || release.manifest?.releaseId !== "patternly-core-0001" || !Array.isArray(release.artifacts)) {
