...
const source = resolve(root, "../patternly-content/artifacts/releases/patternly-core-0003/generated-bundled-content.mjs");
...
if (!release || release.manifest?.releaseId !== "patternly-core-0003" || !Array.isArray(release.artifacts)) {
