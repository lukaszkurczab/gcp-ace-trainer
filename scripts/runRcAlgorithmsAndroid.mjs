...
run("maestro", ["test", "--device", serial, "--test-output-dir", outputDirectory, BOOTSTRAP_FLOW], { stdio: "inherit" }); run("maestro", ["test", "--device", serial, "--test-output-dir", outputDirectory, flow], { stdio: "inherit" });
