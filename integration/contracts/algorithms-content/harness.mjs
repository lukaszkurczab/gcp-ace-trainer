...
function structures(ids) {
  ...
  return {
    ...
    contrastSets: [{ setId: "cross-contrast", setVersion: "v1", primaryMentalUnitId: "contrast_binary_search_vs_linear_scan", contrastedMentalUnitIds: ["recognize_binary_search_signal", "reason_about_indexed_scans"], falseHeuristicId: "cross-false-heuristic", transferBoundary: "cross-fixture-boundary", itemIds: all }],
...
export async function buildCrossRepositoryAlgorithmsRelease() {
  ...
  try {
    ...
    await writeJson(root, "config/taxonomy/algorithms.json", { schemaVersion: "algorithms-taxonomy-v2", trackId: "algorithms", taxonomyVersion: "algorithms-taxonomy-v2", roadmapNodes: [{ id: "binary_search" }, { id: "arrays_and_strings" }, { id: "contrast_binary_search_vs_linear_scan" }], mentalUnits: [{ id: "recognize_binary_search_signal", roadmapNodeId: "binary_search" }, { id: "boundaries_and_loop_invariants", roadmapNodeId: "binary_search" }, { id: "reason_about_indexed_scans", roadmapNodeId: "arrays_and_strings" }, { id: "contrast_binary_search_vs_linear_scan", roadmapNodeId: "contrast_binary_search_vs_linear_scan" }], patternFamilies: [{ id: "binary_search", primaryMentalUnitId: "recognize_binary_search_signal" }, { id: "arrays_and_strings", primaryMentalUnitId: "reason_about_indexed_scans" }], patternVariants: [], problemArchetypes: [], skillAtoms: [{ id: "identify_legal_half_discard_rule", primaryMentalUnitId: "recognize_binary_search_signal" }, { id: "track_index_boundary", primaryMentalUnitId: "reason_about_indexed_scans" }], falseHeuristics: [{ id: "cross-false-heuristic" }] });
