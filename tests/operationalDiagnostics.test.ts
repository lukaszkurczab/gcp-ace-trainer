...
import { describeOperationalFailure, operationalDiagnosticCode } from "../src/application/operationalDiagnostics";
import { StorageWriteError } from "../src/storage/errors";
