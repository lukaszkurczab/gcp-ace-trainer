...
- Każda z dwóch lokalizacji ma 1 298 wpisów najwyższego poziomu w ośmiu plikach oraz 1 485 wartości liści według flatteningu `i18nLocaleParity.test.ts` (tablice są tam liczone jako jedna serializowana wartość). Test parytetu istnieje dla EN/PL.
