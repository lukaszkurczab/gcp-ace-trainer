...
Current source SHA at packet update: `1062f76`
...
| Activity | `Activity` | Populated, empty, filtered-empty, filter selection | Light / Dark | `842:11192`, `842:11410`, `842:11466`; row patterns `830:7642`, `830:8898` | `ActivityScreen`, `ScreenHeader`, `ListRow`, `EmptyState`, sheet primitives | `PARTIAL` | Current-head populated Progress/Activity and filter-sheet captures exist in both themes; compare them against Figma and capture empty, filtered-empty, and large-text states. |
