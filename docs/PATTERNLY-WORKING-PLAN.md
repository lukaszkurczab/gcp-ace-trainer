...
| 11 | ODK-116-A — A5 READY | Producent [A4a1](active/ODK-116/A4A1-REPORT.md), [A4a2](active/ODK-116/A4A2-REPORT.md), [web A4b](active/ODK-116/A4B-REPORT.md) i [spójność A4c](active/ODK-116/A4C-REPORT.md) gotowe; dalej odbiór środowiska testowego bez danych PO. |
