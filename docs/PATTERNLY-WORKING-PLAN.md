...
| 04 | PROFILE-02–05 — PROFILE-02/03 done; następny PROFILE-04 | PROFILE-03 ma świeży dowód Maestro logout→restart→same-account resume oraz kontrolny restart bez markerów pending. Każdy slice zamknąć osobnym raportem, QA, zmianą planu i push na `main`. |
