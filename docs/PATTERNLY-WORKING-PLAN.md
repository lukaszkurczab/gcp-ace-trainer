...
| 11 | ODK-116-A — A1 done | [Walidacja iOS/Android](active/ODK-116/A1-REPORT.md) ukończona; [mapa A2](active/ODK-116/A2-CROSS-REPO-CONTRACT.md) i [schema PL/EN](active/ODK-116/A2-SCHEMA-REPORT.md) gotowe; dalej integracja zmiennych i środowisko testowe. Gotowe wejście dla tłumaczeń dokumentów oraz web. |
