...
| AUD-FIXTURE / E01 | `partial` / READY: B3 | **Nowe:** A — kontrakt ochrony ownera i izolacji ustalony; B1 — lokalny oracle i rozdzielenie smoke/release wykonane; B2a — strzeżone przejście guest po preflight sesji/Auth, wynik `pending`; B2b — kod weryfikacji po restarcie, cleanup i UI smoke wykonany; urządzeniowy owner→guest czeka na syntetyczny owner baseline; B3 — własne konta, seed i bezpieczny cleanup. Nie wymaga ukończenia całego AUD-17. | Powtarzalny dostęp do synthetic owner/guest, sesji, review i ekranów danych; dowód niezmienności chronionych danych ownera. SIM-READY. | [Raport A](active/AUD-FIXTURE/A-REPORT.md), [raport B1](active/AUD-FIXTURE/B1-REPORT.md), [raport B2a](active/AUD-FIXTURE/B2a-REPORT.md), [raport B2b](active/AUD-FIXTURE/B2b-REPORT.md); nowa sekcja w pakiecie AUD (`PATTERNLY-AUDIT-TASKS-2026-09-22.md` — brak w workspace); kryteria w 6.1. |
...
| 04 | AUD-FIXTURE/B3 → B2b-device | B1 oracle i bundle: [raport](active/AUD-FIXTURE/B1-REPORT.md). B2a strzeżone przejście: [raport](active/AUD-FIXTURE/B2a-REPORT.md). B2b kod: [raport](active/AUD-FIXTURE/B2b-REPORT.md), w tym restartowy wynik, cleanup, UI smoke i test konkurencji; urządzenie Guest, brak atestacji ownera. B3: własne konta testowe, kontrolowane dane i cleanup; po syntetycznym owner baseline wznowić Maestro B2b bez `clearState` na istniejącym iPhonie 17 i zebrać dowód zachowania ownera. |
