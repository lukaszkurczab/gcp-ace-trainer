...
| 09 | AUD-08/A1 — READY | [Mapa A0](active/AUD-08/A0-GENERATION-BOUNDARY.md) wykazała brak direct Firestore i szerokie transakcje backendu; zaprojektować źródło/claim/migrację generacji, klasyfikację tras i zabezpieczenie zapisów przed kontraktem recovery A. |
| 09a | AUD-08/A2 — WAIT: A1 | Po kontrakcie generacji spisać stany `operationId`, recovery/reissue, ACK, ochronę wyniku i testy restartu/utraty odpowiedzi; niezależny briefing ≥0,8. |
| 10 | AUD-08/B — WAIT: A1/A2 | Implementacja mobile/backend i testy awarii dopiero po kompletnym, zwalidowanych kontraktach A1/A2. |
