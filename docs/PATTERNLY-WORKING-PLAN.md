...
| ID / epik | Status / dostępność | Najbliższy wynik i zależności | Warunek zamknięcia / bramka | Kontrakt i raport |
| --- | --- | --- | --- | --- |
| ODK-116-A / E07 | `partial` — A4c READY | [A1: walidacja platformowa](active/ODK-116/A1-REPORT.md), [A1b: runtime](active/ODK-116/A1B-REPORT.md), [A2: kontrakt](active/ODK-116/A2-CROSS-REPO-CONTRACT.md), [schema PL/EN](active/ODK-116/A2-SCHEMA-REPORT.md), [A3a: rekord](active/ODK-116/A3A-REPORT.md), [A3b: readiness](active/ODK-116/A3B-REPORT.md), [A4a1: linki](active/ODK-116/A4A1-REPORT.md), [A4a2: eksporter](active/ODK-116/A4A2-REPORT.md) i [A4b: web](active/ODK-116/A4B-REPORT.md) są gotowe. Następnie A4c wyrównuje ścieżki Privacy/Terms w readiness, potem odbiór środowiska testowego. | Kod i szablony działają bez hardcode’u operatora; brak wartości produkcyjnych nie blokuje dev bootstrap. Niekompletna konfiguracja release jest wykrywana. Kompletny iOS przechodzi bez pól Androida, brak pola iOS failuje, a jawny Android nadal wymaga własnych pól i providerów. SIM-READY. | Pakiet wejść ODK-116 (`ODK-116-INPUTS-PACKET.md` — brak w workspace) do aktualizacji; wymagania w 6.2. |
...
| 11 | ODK-116-A — A4c READY | Producent [A4a1](active/ODK-116/A4A1-REPORT.md), [A4a2](active/ODK-116/A4A2-REPORT.md) i [web A4b](active/ODK-116/A4B-REPORT.md) gotowe; dalej A4c spójność ścieżek readiness, potem środowisko testowe. |
