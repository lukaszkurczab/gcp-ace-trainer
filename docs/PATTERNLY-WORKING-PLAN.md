...
| 10 | AUD-08/B1a — READY; B1b–B4 WAIT | B1a: źródło generacji, claim, wymiana sesji i migracja. B1b: guard tras i transakcyjne zabezpieczenie magazynów. B1c: integracyjny test Firebase initial/refresh oraz macierz tras. B2: wspólny slot, operacje, AEAD, API. B3: trwała próba i ACK w mobile. B4: awarie/restart/Maestro na jednym iPhonie 17. Nie usuwać provider revoke ani nie włączać takeover przed PASS B1c. [A1](active/AUD-08/A1-AUTHORIZATION-GENERATION-CONTRACT.md), [A2](active/AUD-08/A2-RECOVERY-PROTOCOL.md). |
