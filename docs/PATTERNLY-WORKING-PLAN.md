...
| 11 | ODK-116-A — A1 done | [Walidacja iOS/Android](active/ODK-116/A1-REPORT.md) ukończona; dalej schema zmiennych i środowisko testowe. Gotowe wejście dla tłumaczeń dokumentów oraz web. |
