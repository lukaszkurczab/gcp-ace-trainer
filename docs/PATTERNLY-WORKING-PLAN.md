...
| 09a | AUD-08/A2 — READY | Po kontrakcie generacji spisać stany `operationId`, recovery/reissue, ACK, ochronę wyniku i testy restartu/utraty odpowiedzi; niezależny briefing ≥0,8. |
