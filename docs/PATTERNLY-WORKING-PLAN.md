...
| 25 | ODK-117-A1 done → A2 WAIT: linguistic review → A3 → A4 → A5 | A1 odebrane. A2 wymaga pięciu kompetentnych przeglądów językowych dla 7 605 wartości; brak procesu/reviewerów, a modelowy self-review nie jest dowodem. Nie rozpoczynać A3 przed zweryfikowaniem pakietów A2. Kontynuować niezależny PROFILE-02/C. |
