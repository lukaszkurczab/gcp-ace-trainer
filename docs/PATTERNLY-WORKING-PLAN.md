...
| 10 | AUD-08/B1b0–B1b2a — done; B1b2b READY; reszta WAIT | [B1a raport i QA](active/AUD-08/B1A-REPORT.md): źródło generacji, claim, wymiana sesji. [B1b0 mapa](active/AUD-08/B1B0-STORE-ROUTE-MAP.md) i [57 tras/magazynów](active/AUD-08/B1B0-ROUTE-MATRIX.md): QA PASS. [B1b1 raport i QA](active/AUD-08/B1B1-REPORT.md): claim→żądanie i users legal/purchase. [B1b2a raport i QA](active/AUD-08/B1B2A-REPORT.md): progress/sync i one-shot adoption. B1b2b: pozostałe zwykłe zapisy; B1b3: transfer staging/apply; B1b4: delete i webhook/admin. B1c: Firebase initial/refresh, test wyścigów, typed reauth i bramka gotowości wydania po lokalnym egzekwowaniu. B2: operacje recovery/reissue; B3: mobile ACK; B4: awarie/restart/Maestro na jednym iPhonie 17. Nie usuwać provider revoke ani nie włączać takeover przed PASS B1c. [A1](active/AUD-08/A1-AUTHORIZATION-GENERATION-CONTRACT.md), [A2](active/AUD-08/A2-RECOVERY-PROTOCOL.md). |
