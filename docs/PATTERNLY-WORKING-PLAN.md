...
| 10 | AUD-08/B1a — done; B1b READY; B1c–B4 WAIT | [B1a raport i QA](active/AUD-08/B1A-REPORT.md): źródło generacji, claim, wymiana sesji i migracja; egzekwowanie jeszcze wyłączone. B1b: propagacja oczekiwanej generacji, guard tras i transakcyjne zabezpieczenie magazynów bez claimless fallbacku. B1c: integracyjny test Firebase initial/refresh, macierz tras/zapisów, typed reauth po rotacji i bramka dystrybucji przed włączeniem egzekwowania. B2: wspólny slot, operacje, AEAD, API. B3: trwała próba i ACK w mobile. B4: awarie/restart/Maestro na jednym iPhonie 17. Nie usuwać provider revoke ani nie włączać takeover przed PASS B1c. [A1](active/AUD-08/A1-AUTHORIZATION-GENERATION-CONTRACT.md), [A2](active/AUD-08/A2-RECOVERY-PROTOCOL.md). |
