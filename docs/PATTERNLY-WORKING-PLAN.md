...
| 04 | PROFILE-02–05 — PROFILE-02 done; READY: PROFILE-03 | PROFILE-02/C potwierdziło jednego bieżącego Gościa i izolację Guest/A/B; B pozostaje anulowane. Następnie offline logout z zachowaniem danych konta, oba wybory adopcji i usunięcie starego oracle oraz syntetycznej kompatybilności. Każdy slice zamknąć osobnym raportem, QA, zmianą planu i push na `main`. |
