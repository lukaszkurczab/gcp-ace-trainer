...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App             | app source baseline: `2b19f81`; `origin/main` nie został zmieniony w tym tasku                                                                                                                                                                                                                                                                               | Current source passes recovery 287/116/564, TypeScript, 573/573 tests, content-boundary, and runtime-privacy checks. Partial current-head runtime evidence now exists for Settings/Notifications; full matrix capture and owner approval remain pending. |
...
| Maestro         | Explicitny binary `2.6.1` z `/Users/lukaszkurczab/.maestro/bin/maestro` wykonał current-head capture na iPhone 16 Pro / iOS 18.6 (`00B8F5B5-DF44-4621-8E30-56927604FA96`) dla Settings i zablokowanych Notifications w Dark, Light oraz dużym tekście. | Dowody pozostają poza worktree: `/tmp/patternly-capture-current-head-dark-2026-08-24/`, `/tmp/patternly-capture-current-head-large-text-2026-08-24/`, `/tmp/patternly-capture-current-head-large-text-dark-2026-08-24/`. Pełna macierz wszystkich reachable states, Android, signed/distribution rendering, Figma comparison i owner approval nadal są otwarte; Android nie ma urządzenia. |
