...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App             | app source baseline: `ec888d9`; `origin/main` nie został zmieniony w tym tasku                                                                                                                                                                                                                                                                               | Focused ChoiceRow/settings/visual checks and typecheck passed on the current source. Full current-head QA and runtime capture remain pending; historical remote CI evidence is not current-head proof. |
...
48. Rewalidacja bieżącego kanału względem współdzielonego Figma `Pattern / Appearance Choice` (`619:5237`) i stress instance `882:14452` wykazała bezpieczną rozbieżność kolejności: referencja układa preview → copy → radio, a canonicalny `ChoiceRow` renderował radio przed copy. Commit `ec888d9` przenosi radio za elastyczną treść w jednym ownerze, bez zmiany wartości, persistence, a11y ani komend; obejmuje Appearance, Goal cadence i compact Practice Setup. Focused settings/visual/goal checks przeszły 21/21, a TypeScript i `git diff --check` przeszły. Full current-head QA, runtime Light/Dark/200% capture i Product Owner approval pozostają otwarte.
